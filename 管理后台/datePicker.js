...
;(function($, window, document, undefined) {
	...
	Plugin.prototype.init = function() {
		...
		if(!root.length) {
			...
			$('<div class="caltime"><button type="button" class="btn btn_submit fr" name="submit">确认</button><input id="calHour" type="hidden" class="input" min="0" max="23" size="2" value="0"><span></span><input id="calMin" class="input" type="hidden" size="2" min="1" max="59" value="0"><span></span></div>').appendTo(body);
